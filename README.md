...
- [Starting from a Neptune database with data: Air Routes Example](https://github.com/aws/amazon-neptune-for-graphql/tree/main/doc/routesExample.md)
...
- [Starting from a GraphQL schema and an empty Neptune database: Todo Example](https://github.com/aws/amazon-neptune-for-graphql/tree/main/doc/todoExample.md)
...
- [Commands reference: utility CLI options](https://github.com/aws/amazon-neptune-for-graphql/tree/main/doc/cliReference.md)
...
#### References:
- [here](https://github.com/aws/amazon-neptune-for-graphql/tree/main/doc/todoExample.md) an example using a TODO GraphQL schema, showing the outputs of the utility.
- If you are wondering which AWS resources the utility is creating, look at the section below.
- To customize the GraphQL schema, look at the section below.
...
### @alias
This directive can be applied to GraphQL schema types or fields. It maps different names between the graph database and the GraphQL schema. The syntax is *@alias(property: your-name)*. In the example below *airport* is the graph database node label mapped to the *Airport* GraphQL type, and *desc* is the property of the graph database node mapped to the field *description*. See the [Air Routes Example](https://github.com/aws/amazon-neptune-for-graphql/tree/main/doc/routesExample.md). The GraphQL guidence is pascal case for types and camel case for fields.
...
<br>
See the [Todo Example](https://github.com/aws/amazon-neptune-for-graphql/tree/main/doc/todoExample.md) and the [Air Routes Example](https://github.com/aws/amazon-neptune-for-graphql/tree/main/doc/routesExample.md).
...
With the CLI option `--create-update-aws-pipeline`, and its accesory options ([see the commands reference](https://github.com/aws/amazon-neptune-for-graphql/tree/main/doc/cliReference.md)), the utility automatically creates the resources.<br>
...
The code of the utiliy uses the JavaScript AWS sdk v3, if you'd like to review the code is only in [this file](https://github.com/aws/amazon-neptune-for-graphql/tree/main/src/pipelineResources.js).

### I prefer a CDK file
To option to trigger the creation of the CDK file starts with `--output-aws-pipeline-cdk`, and its accessory options ([see the commands reference](https://github.com/aws/amazon-neptune-for-graphql/tree/main/doc/cliReference.md)). <br> 
...
See CDK end to end example [here](https://github.com/aws/amazon-neptune-for-graphql/tree/main/doc/cdk.md).

### Let me setup the resources manually or with my favorite DevOps toolchain
[Here](https://github.com/aws/amazon-neptune-for-graphql/tree/main/doc/resources.md) the detailed list of resorces needed to configure the GraphQL API pipeline.
<br>
