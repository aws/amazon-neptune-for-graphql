...
import { schemaParser, schemaStringify } from './src/schemaParser.js';
import { validatedSchemaModel} from './src/schemaModelValidator.js';
import { resolverJS } from './src/resolverJS.js';
...
// If no arguments are provided, suggest help
